...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KHAN-MD~gDE02CIB#wvDmqjhwCmX4E3V6MdauQXtY789j21TZ08gsk1RMyiQ",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "i_am_Ѧ𝖋คℚ",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "i_am_Ѧ𝖋คℚ",
...
OWNER_NAME: process.env.OWNER_NAME || "A√@×",
// add bot owner name
...
LIVE_MSG: process.env.LIVE_MSG || "> Kaise anna hua *i_am_Ѧ𝖋คℚ*👑",
// add alive msg here 
...
DEV: process.env.DEV || "923251073157",
